...
- **LibreOffice** (for Office→PDF conversions only)
  ...
  - Windows: download from [libreoffice.org](https://www.libreoffice.org/download/) — after installing, add `C:\Program Files\LibreOffice\program` to your system PATH, then restart your terminal
