...
const FONT_OPTIONS = ['Helvetica', 'Times Roman', 'Courier', 'Inter', 'DM Sans', 'Georgia', 'Custom...']
    ...
    <ToolShell tool={tool} onBack={onBack} loading={loading} loadingLabel="Applying your watermark">
      ...
      <input
        ...
        onChange={async e => {
          ...
          // Reset fontFamily to avoid showing "Custom..." when a custom font is selected
          if (f) setFontFamily('Helvetica')
          if (!f) return
          try {
